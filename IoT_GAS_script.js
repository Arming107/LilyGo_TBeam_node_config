/*
 * PROJECT: Scrip implementation on script.google.com for IoT
 * AUTHOR: Armin Gembal
 * DATE: April 2026
 * DESCRIPTION:
...
function doPost(e) {
  ...
  // Jednoduchá podmínka, která překládá přijaté číslo z desky na text.
  if (number === 1) {
    textToSend = "Senzor aktivován (Pin 13)!";
  }

  // Zavolá funkci pro odeslání na Telegram.
