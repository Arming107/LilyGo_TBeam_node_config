...
#define PIN_POHYB  GPIO_NUM_14   // Motion sensor
#define PIN_VIBRACE GPIO_NUM_25  // Vibration sensor
#define PIN_MIKROFON GPIO_NUM_13 // Sound sensor
...
void setup() {
    ...
    if (payload > 0) {
        ...
        do_send(&sendjob);  // Send message. This calls our do_send function defined earlier.
    } else {
